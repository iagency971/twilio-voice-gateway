...
def main():
 ...
 a=lab.label_one(bars(102.2,100.8),path(99.5,100.5),'REAL');b=lab.label_one(bars(102.2,100.8),path(98.5,100.5),'REAL')
 ...
 c=lab.label_one(bars(102.2,99.8),path(99.5,100.5),'REAL');assert c['primary_class']=='AMBIGUOUS_SAME_BAR' and c['primary_binary_label']==0
